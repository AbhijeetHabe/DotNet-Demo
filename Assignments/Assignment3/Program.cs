namespace Assignment3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Manager manager1 = new Manager("Manager1", "Aniket", 33000, 11);
            Manager manager2 = new Manager("Manager2", "Raj", 20000, 12);
            Manager manager3 = new Manager("Manager3", "Swaraj", 16000, 13);
